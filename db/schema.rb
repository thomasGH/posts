...
ActiveRecord::Schema.define(version: 20151125073311) do
  ...
  add_index "subscribers_posts", ["post_id"], name: "index_subscribers_posts_on_post_id", using: :btree
  add_index "subscribers_posts", ["user_id"], name: "index_subscribers_posts_on_user_id", using: :btree
